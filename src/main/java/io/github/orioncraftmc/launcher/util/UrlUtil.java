...
public final class UrlUtil {
	...
	public static Path getCodeSource(URL url, String localPath) throws Exception {
		...
		if (connection instanceof JarURLConnection) {
			...
			if (path.endsWith(localPath)) {
				...
				throw new Exception("Could not figure out code source for file '" + localPath + "' in URL '" + url + "'!");
			}
		}
	}
